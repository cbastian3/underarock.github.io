...
var texture0 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_pz.jpg' );
var texture1 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_px.jpg' );
var texture2 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_nx.jpg' );
var texture3 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_ny.jpg' );
var texture4 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_nz.jpg' );
var texture5 = textureLoader.load( 'js/THREE.js-master/src/examples/textures/cube/MilkyWay/dark-s_py.jpg' );
...
var materials = [
  ...
  ManualSkyBox.scale.set(100, 100, 100);
...
function loadModels() {
  ...
  loader.load( 'models/Amythest_export3_movedorigin.glb', gltf => onLoad( gltf, Position2, newStandard), onProgress, onError );
