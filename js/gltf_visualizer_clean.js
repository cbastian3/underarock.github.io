...
//creating this to try to rotate the GLTF
let meshObject

//stuff I need to play audio
// let fftSize = 128;
let listener = new THREE.AudioListener();
let audio = new THREE.Audio( listener );
let mediaElement = new Audio( 'audio/ItCouldHappenToYou.mp3' );

//this is what I want to pass to the parrotPosition or to meshObject.rotate
let noise
...
function createLights() {
  ...
  mainLight.position.set( 15, 44, 65 );
...
function loadModels() {
  ...
  let noise = analyser.getAverageFrequency();
  ...
  /* const animation = gltf.animations[ 0 ];
    ...
    */
    ...
    let meshObject = new THREE.object;
